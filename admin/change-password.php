...
$query=mysqli_query($con,"select ID from tbladmin where ID='$adminid' and   Contraseña='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbladmin set Contraseña='$newpassword' where ID='$adminid'");
