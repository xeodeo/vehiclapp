...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  tblcategoria(TipoVehiculo) value('$catname')");
    if ($query) {
                            ...
                            <div class="card-body card-block ">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group ">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nombre de Categoria</label></div>
                                        <div class="col-12 col-md-9 bg-dark "><input type="text" id="catename" name="catename" class="form-control bg-secondary text-white " placeholder="Categoría de vehículo" required="true"></div>
                                    </div>
